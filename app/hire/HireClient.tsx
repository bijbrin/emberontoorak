      ...
      <main className="min-h-screen bg-obsidian">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse at 30% 30%, rgba(254,119,67,0.10) 0%, rgba(68,125,155,0.05) 35%, transparent 70%)',
            }}
          />
                ...
                return (
                  <motion.article
                    ...
                    className={`rounded-2xl border transition-all duration-300 ${
                      isSelected
                        ? 'border-gold/55 bg-linear-to-br from-gold/8 via-surface/40 to-obsidian/40 shadow-[0_0_32px_rgba(254,119,67,0.10)]'
        ...
        >
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse at 70% 0%, rgba(254,119,67,0.06) 0%, transparent 55%)',
            }}
          />
