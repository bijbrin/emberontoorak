  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 50% 0%, rgba(254,119,67,0.08) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative z-10 py-20 sm:py-24 lg:py-28 section-x border-b border-gold/10 text-center">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="btn-shimmer px-10 py-4 rounded-full bg-gold text-obsidian text-[11px] sm:text-xs tracking-[0.25em] uppercase font-medium hover:shadow-[0_0_40px_rgba(254,119,67,0.45)] transition-shadow duration-500"
        >
          Book a Table
        </motion.button>
        </div>
