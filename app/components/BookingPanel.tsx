    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div data-lenis-prevent className="p-6 sm:p-8 flex-1 overflow-y-auto overscroll-contain flex flex-col">
              {/* Header */}
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6 flex-1">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ backgroundImage: 'repeating-linear-gradient(45deg, rgba(254,119,67,0.6) 0 1px, transparent 1px 14px)' }}
                      />
                          ...
                          <motion.button
                            ...
                            className={`absolute flex flex-col items-center justify-center font-medium transition-colors duration-300 ${
                              ...
                              isBooked
                                ...
                                : isSelected
                                  ? 'bg-ember text-obsidian border-2 border-gold shadow-[0_0_24px_rgba(254,119,67,0.65)]'
                  ...
                  <div className="mt-auto pt-2">
                    <motion.button
                      ...
                      className="btn-shimmer w-full py-4 bg-gold text-obsidian text-[11px] sm:text-xs tracking-[0.25em] uppercase font-medium rounded-full hover:shadow-[0_0_30px_rgba(254,119,67,0.4)] transition-shadow duration-500 disabled:opacity-60"
                    >
